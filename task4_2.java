...
public class task4_2 {
    ...
    public static void main(String[] args) {
        LinkedList<String> listLinked= new LinkedList<>(
                Arrays.asList("a23", "fsk", "sDk", "987", "df7", "321", "sd-room", "8", "d1"));
        ...
        while (scn.hasNextLine()) {
            ...
            String numberOperationLine = scn.nextLine();
            int numberOperation = Integer.parseInt(numberOperationLine);
            if (numberOperation == 1) {
                ...
                System.out.println("Некоррекный ввод!! Перевведите!!");
            }
        }
        scn.close();        
    }
